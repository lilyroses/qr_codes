...
# STEP 3. CONVERT BINARY CODEWORDS TO INTEGERS
...
data_cw_ints = convert_binary_codewords_to_ints(encoded_bytes)
...
print(f"\nALL BYTES:\n")
for i, eb in enumerate(encoded_bytes):
  print(i, eb, data_cw_ints[i])
